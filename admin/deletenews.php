        ...
        <h3><a class="" href="../admin/">Admin</a> | <a href="news.php">News:</a>
            <small>
                <select name="news" onChange="window.document.location.href=this.options[this.selectedIndex].value;">
                    <option selected>Select A Story to Delete:</option>
<?php
...
?>
                    <option value="deletenews.php?id=<?php echo $newsID; ?>"><?php echo $weekID.".".$dayID.".".$hourID.".".$news_title.",  ".$type; ?></option>
<?php
                    $count++; 
   }
                    $con->next_result();
...
<?php 
    ...
    ?>
        <hr> 
<form method="post" action="newsdeleted.php">
          ...
          <div class="card">
            <div class="card-body">
              <span class="card-text">Paragraph</span><br>
                <textarea name="news_paragraph" placeholder="Paragraph"><?php echo $news_paragraph; ?></textarea><br>

                <span class="card-text">Description</span><br>
                <textarea name="news_description" placeholder="Description"><?php echo $news_description; ?></textarea><br>
      ...
      <div class="row">
            <div class="col-lg-12 col-sm-12">
                <div class="text-center">
                  <button type="submit" class="btn btn-danger">DELETE THIS NEWS RECORD</button>
                </div>
            </div>
        </div>
    </form>           
