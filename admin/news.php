        ...
        <h3><a class="" href="../admin/">Admin</a> | <a href="news.php">News:</a>
            <small>
                <select name="news" onChange="window.document.location.href=this.options[this.selectedIndex].value;">
                    ...
                    <option value="newnews.php">INSERT A NEW NEWS STORY!</option>
<?php 
...
?>
                    <option value="news.php?id=<?php echo $newsID; ?>"><?php echo $weekID.".".$dayID.".".$hourID.".".$news_title.",  ".$news_type; ?></option>
<?php
                    $count++; 
   }
                    $con->next_result();
