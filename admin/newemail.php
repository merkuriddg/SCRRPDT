...
<script src="../summernote/dist/summernote-lite.js"></script></head>
<body>
<?php include('menu.php'); ?>

<div class="main">
    <div class="container">
        <h3><a class="" href="../admin/">Admin</a> | New <a class="" href="email.php">Email:</a>
...
<!-- option data-value="<-php echo ($mailtoid); ?>" -->
         <script>
                ...
                <input list="tooptions" type="text" style="border-radius:0px;" name="mail_to_id" id="mail_to_id" placeholder="To:" size="50">
...
<!-- FROM -->
                ...
                <input list="fromoptions" type="text" style="border-radius:0px;" name="mail_from_id" id="mail_from_id" placeholder="From:" size="50">
 ...
 <!-- CC1: -->
                ...
                <span class="card-text">CC:</span>
                <input list="cc1options" type="text" style="border-radius:0px;" name="mail_cc1_id" id="mail_cc1_id" placeholder="CC1:" size="50">
...
<!-- CC2: -->
                ...
                <span class="card-text">CC:</span>
                <input list="cc2options" type="text" style="border-radius:0px;" name="mail_cc2_id" id="mail_cc2_id" placeholder="CC2:" size="50">
...
<!-- CC3: -->
                ...
                <input list="cc3options" type="text" style="border-radius:0px;" name="mail_cc3_id" id="mail_cc3_id" placeholder="CC3:" size="50">
...
<br>
                ...
                <input type="text" name="email_subject" placeholder="Subject" size="50"><br>
                
                <textarea id="summernote" name="email_body" placeholder="Body"></textarea>
      ...
      <div class="row">
            <div class="col-lg-12 col-sm-12">
                <div class="text-center">
                  <button type="submit" class="btn btn-danger">INSERT NEW EMAIL </button>
                </div>
            </div>
        </div>
    </form>           
