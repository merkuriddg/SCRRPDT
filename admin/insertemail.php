...
$sql = "
    INSERT into email 
    (weekID, dayID, hourID, email_type, email_to, email_from, email_cc1, email_cc2, email_cc3, email_subject, email_body, email_attachment, email_attachment_url)
    VALUES ('$weekID', '$dayID', '$hourID', '$mail_type', '$mail_to','$mail_from','$mail_cc1','$mail_cc2','$mail_cc3','$email_subject', '$email_body', '$email_attachment', '$email_attachment_url');";
