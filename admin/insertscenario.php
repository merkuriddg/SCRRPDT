...
$sql = "
    ...
    (weekID, dayID, hourID, type, scenario_title, scenario_desc, scenario_goal, scenario_objective, scenario_difficulty)
    VALUES ('$weekID', '$dayID', '$hourID', '$type', '$scenario_title', '$scenario_desc', '$scenario_goal', '$scenario_objective', '$scenario_difficulty');";
