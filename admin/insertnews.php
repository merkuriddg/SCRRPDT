...
$sql = "
    INSERT into news 
    (weekID, dayID, hourID, news_type, news_title, news_paragraph, news_source, news_source_url, news_img_url)
    VALUES ('$weekID', '$dayID', '$hourID', '$news_type', '$news_title', '$news_paragraph', '$news_source', '$news_source_url', '$news_img_url');";
          ...
          <div class="card">
            <div class="card-body">
              <span class="card-text">Paragraph</span><br>
                ...
                <textarea name="news_source_url" placeholder="News Source URL"><?php echo $news_source_url; ?></textarea><br>
                Test the link: <a href="<?php echo $news_source_url; ?>" target="_blank"><?php echo $news_source_url; ?></a>
