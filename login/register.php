...
if(isset($_POST['submit'])){
	...
	if(!isset($error)){
		...
		try {
			...
			$fname = $_POST['fname'];
			$lname = $_POST['lname'];
			$body = "<p>Thank you, $fname, for registering at the SCRRPDT site.</p>
			<p>To activate your account, please click on this link: <a href='".DIR."activate.php?f=$fname&l=$lname&x=$id&y=$activasion&z=$email'>".DIR."activate.php?f=$fname&l=$lname&x=$id&y=$activasion&z=$email</a></p>
			<p>Regards,<br>Your SCRRPDT Admin</p>";
...
//define page title
$title = 'Arr Aye Tea Admin Dashboard Login';
			...
			<form role="form" method="post" action="" autocomplete="off">
				...
				<div class="row">
					<div class="col-xs-6 col-sm-6 col-md-6">
						<div class="form-group">
							<input type="text" name="fname" id="fname" class="form-control input-lg" placeholder="First Name" tabindex="3">
						</div>
					</div>
					<div class="col-xs-6 col-sm-6 col-md-6">
						<div class="form-group">
							<input type="text" name="lname" id="lname" class="form-control input-lg" placeholder="Last Name" tabindex="4">
						</div>
					</div>
				</div>
				<div class="row">
