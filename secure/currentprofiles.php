    ...
    <div class="row">
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 xs-12">
                        <span><i class="fa fa-clock"></i> <b><?php echo $companyname; ?>'s Current Profiles -</b> <em> This is Where We Are </em></span>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="box box-default collapsed-box box-solid margin " style="width:98%;">
                            ...
                            <div class="box-body">
                                <table width="100%" border="1">
                                    ...
                                    AND (NIST_profiles.Profile = 'Current')
                                    ...
                                    ORDER BY NIST_profiles.ProfileStartDate DESC;";
...
//                                            if(isset($_POST['submit']) && $id=$_POST['id']){$MIL = $_POST['MIL'];
 //                                               echo "MIL:" .$MIL.": ".$id;  // Displaying Selected Value
  //                                          }
...
//                                            echo '<input type="submit" name="submit" value="Update MIL" /><input type="hidden" name="id" value="'.$id.'"></form>';
                                            ...
                                            echo '<td class="nist-left nist-center" width="5%">';
                                            echo '<a href="editprofileitem.php?id='.$id.'&pt=c&f='.$FunctionID.'&c='.$CategoryID.'&s='.$SubCatID.'&mid='.$MissionID.'" class="nist-link"><i class="fa fa-edit"></i></a>';
                                            echo '</td>'. PHP_EOL;
                                            echo '</tr>'. PHP_EOL;
