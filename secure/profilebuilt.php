            ...
            <div class="box-header">
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-lg-12">
                                <span><i class="fa fa-clock"></i> <b> Completed <?php echo $Profile; ?> Profile -  </b> <em><?php echo $ProfileName; ?> </em></span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="box-body">
                            <?php foreach ($depts as $v) { ?>
                                <div class="box box-default box-solid margin " style="width:98%;">
                                    ...
                                    AND (NIST_profiles.TransactionID = '".$UID."')
                                    GROUP BY NIST_profiles.id";
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                    ...
                                                    echo  PHP_EOL;
                                                    echo '<tr>'. PHP_EOL;
                                                    echo '<td class="nist-left" width=5%>' . $ProfileName . '</td>'. PHP_EOL;
                                                    ...
                                                    echo '<td class="nist-left nist-center" width="5%"><a href="editMIL.php" class="nist-link"><i class="fa fa-check-square"></i></a></td>'. PHP_EOL;
                                                    echo '</tr>'. PHP_EOL;
