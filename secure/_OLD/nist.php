    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="nav-tabs-custom">
                ...
                <li class="<?php if ($id=='CSF') echo 'active';?>"><a href="#quick" data-toggle="tab">NIST CSF</a>
                </li>
                <li class="<?php if ($id=='ID') echo 'active';?>"><a href="#identify" data-toggle="tab">Identify</a>
                </li>
                <li class="<?php if ($id=='PR') echo 'active';?>"><a href="#protect" data-toggle="tab">Protect</a>
                </li>
                <li class="<?php if ($id=='DE') echo 'active';?>"><a href="#detect" data-toggle="tab">Detect</a>
                </li>
                <li class="<?php if ($id=='RS') echo 'active';?>"><a href="#respond" data-toggle="tab">Respond</a>
                </li>
                <li class="<?php if ($id=='RE') echo 'active';?>"><a href="#recover" data-toggle="tab">Recover</a>
                </li>
                <li class="<?php if ($id=='') echo 'active';?>"><a href="#overall" data-toggle="tab">Full NIST CSF</a>
                </li>
            </ul>


                <div class="tab-content">
                    <div id="quick" class="tab-pane <?php if ($id=='CSF') echo 'active';?>">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="panel panel-default">
                                        ...
                                        <p class="nist-title">Information here about the CRR</p>
                                            ...
                                            <ul >
                                                <li class="crr"><a href="NIST/CRR_Resource_Guide-AM.pdf" class="crr-link" target="_blank">Asset Management [pdf]:</a><br>
                                                The Asset Management guide focuses on the processes used to identify, document, and manage the organization’s assets.
                                                </li>
                                                <li class="crr"><a href="NIST/CRR_Resource_Guide-CM.pdf" class="crr-link" target="_blank">Controls Management [pdf]:</a><br>
                                                ...
                                                <li class="crr"><a href="NIST/CRR_Resource_Guide-CCM.pdf" class="crr-link" target="_blank">Configuration and Change Management [pdf]:</a><br>
                                                ...
                                                <li class="crr"><a href="NIST/CRR_Resource_Guide-VM.pdf" class="crr-link" target="_blank">Vulnerability Management [pdf]:</a><br>
                                                ...
                                                <li class="crr"><a href="NIST/CRR_Resource_Guide-IM.pdf" class="crr-link" target="_blank">Incident Management [pdf]:</a><br>
                                                ...
                                                <li class="crr"><a href="NIST/CRR_Resource_Guide-SC.pdf" class="crr-link" target="_blank">Service Continuity Management [pdf]:</a><br>
                                                ...
                                                <li class="crr"><a href="NIST/CRR_Resource_Guide-RM.pdf" class="crr-link" target="_blank">Risk Management [pdf]:</a><br>
                                                ...
                                                <li class="crr"><a href="NIST/CRR_Resource_Guide-EDM.pdf" class="crr-link" target="_blank">External Dependencies Management [pdf]:</a><br>
                                                ...
                                                <li class="crr"><a href="NIST/CRR_Resource_Guide-TA.pdf" class="crr-link" target="_blank">Training and Awareness [pdf]:</a><br>
                                                ...
                                                <li class="crr"><a href="NIST/CRR_Resource_Guide-SA.pdf" class="crr-link" target="_blank">Situational Awareness [pdf]:</a><br>
                    ...
                    <!-- ################################################################################################################################################ -->
                    <div id="identify" class="tab-pane <?php if ($id=='ID') echo 'active';?>">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="scrollTable">
                                        ...
                                        while ($row = mysqli_fetch_array($result)){
                                            ...
                                            if ($temp_categorycode != $csf_categorycode) {
                                                echo '<td align="left" colspan="3" width="100%" valign="left" class="nist-title"><br>' . $csf_category . '</td>';
                                                echo '</tr>';


                                                if ($temp_subcategory != $csf_subcategory) {
                                                    echo '<tr align="left">';
                                                    echo '<td align="left" colspan="3" width="100%" valign="left" class="nist-left">' . $csf_categorytext . '</td>';
                                                    echo '</tr>';
                                                }
                                            }

                                            echo '<tr align="left" style="border-bottom: 1px gray solid;">';
                                            echo '<td align="left" width="10%" valign="left" class="nist-link">';
                                            echo '<a class="nist-link" href="crosswalk.php?'.$csf_functioncode.'.'.$csf_categorycode.'-'.$csf_number.'"> <input id="check-a" onchange="" type="checkbox"> '.$csf_functioncode.'.'.$csf_categorycode.'-'.$csf_number.'</a>';
                                            echo '</td>';
                                            echo '<td align="left" width="75%" valign="left" class="nist-left">' . $csf_subcategory . '</td>';
                                            echo '<td align="left" width="15%" valign="left" class="nist-center"><form action="updateMIL.php" method="post"><input type="hidden" value="'.$csf_functioncode.'.'.$csf_categorycode.'-'.$csf_number.'">';
                    ...
                    <!-- ################################################################################################################################################ -->
                    <div id="protect" class="tab-pane <?php if ($id=='PR') echo 'active';?>">
                        <div class="box-header">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Protect
                                ...
                                <div class="panel-body">
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="scrollTable">
                                        ...
                                        while ($row = mysqli_fetch_array($result)){
                                            ...
                                            if ($temp_categorycode != $csf_categorycode) {
                                                echo '<tr align="left">';
                                                echo '<td align="left" colspan="2" width="100%" valign="left" class="nist-title"><br>' . $csf_category . '</td>';
                                                echo '</tr>';


                                                if ($temp_subcategory != $csf_subcategory) {
                                                    echo '<tr align="left">';
                                                    echo '<td align="left" colspan="2" width="100%" valign="left" class="nist-left">' . $csf_categorytext . '</td>';
                                                    echo '</tr>';
                                                }
                                            }

                                            echo '<tr align="left" style="border-bottom: 1px gray solid;">';
                                            echo '<td align="left" width="5%" valign="left" class="nist-link">';
                                            ...
                                            echo '</td>';
                                            echo '<td align="left" width="80%" valign="left" class="nist-left">' . $csf_subcategory . '</td>';
                                            echo '<td align="left" width="15%" valign="left" class="nist-center"><form action="updateMIL.php" method="post"><input type="hidden" value="'.$csf_functioncode.'.'.$csf_categorycode.'-'.$csf_number.'">';
                                            echo 'MIL:<input type="text" size="1" style="background-color: transparent;" value="'.$csf_score.'" onClick="this.select();" >'.$csf_mil.' <input type="submit" value="UPDATE" style="background-color: lightskyblue;">';
                                            echo '</form></td>';
                                            echo '</tr>';
                    ...
                    <!-- ################################################################################################################################################ -->
                    <div id="detect" class="tab-pane <?php if ($id=='DE') echo 'active';?>">
                        <div class="box-header">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Detect
                    ...
                    <!-- ################################################################################################################################################ -->
                    <div id="respond" class="tab-pane <?php if ($id=='RS') echo 'active';?>">
                        <div class="box-header">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Respond
                    ...
                    <!-- ################################################################################################################################################ -->
                    <div id="recover" class="tab-pane <?php if ($id=='RE') echo 'active';?>">
                        <div class="box-header">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Recover
                    ...
                    <!-- ################################################################################################################################################ -->
                    <div id="overall" class="tab-pane <?php if ($id=='') echo 'active';?>">
                        <div class="box-header">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Full NIST CSF
                                ...
                                <div class="panel-body">
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="scrollTable">
                                        ...
                                        if ($temp_functioncode != $csf_functioncode) {
                                            echo '<tr align="left">';
                                            echo '<td align="left" colspan="2" width="100%" valign="left" class="nist-title"><br>' . $csf_function . '</td>';
                                            echo '</tr>';
