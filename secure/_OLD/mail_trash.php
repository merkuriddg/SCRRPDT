...
//Get_All_Member_Email
  ...
  "CALL get_all_member_email_trash('" .$_SESSION['memberID']. "')")
      or 
...
echo '  <tr>
        <td class="mailbox-name" width="30%"><i class="fa fa-trash-o"></i>  <a href="mail_read.php?id='.$mail_id.'" class="mail-unread">' .  substr(($from),0,40) . '</a><br><span class="mail-unread">'. $mail_time .'</span><br>';
?>
                <div class="btn-group">
                      
                  <button onclick="window.location.href='mail_destroy.php?id=<?php echo ($mail_id);?>'" type="button" class="btn btn-default btn-sm"><i class="fa fa-ban" data-toggle="tooltip" title="Destroy"></i></button>
                    <button onclick="window.location.href='mail_restore.php?id=<?php echo ($mail_id);?>'" type="button" class="btn btn-default btn-sm"><i class="fa fa-level-up" data-toggle="tooltip" title="Move to Inbox"></i></button>
              </div>
