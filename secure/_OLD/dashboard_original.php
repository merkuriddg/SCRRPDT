            ...
            <div class="col-lg-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#offenses" data-toggle="tab">Offenses</a></li>
                        <li><a href="#logs" data-toggle="tab">Log Activity</a></li>
                        <li><a href="#network" data-toggle="tab">Network Activity</a></li>
                        <li><a href="#assets" data-toggle="tab">Assets</a></li>
                        <li><a href="#reports" data-toggle="tab">Reports</a></li>
                        <li><a href="#risks" data-toggle="tab">Risks</a></li>
                        <li><a href="#users" data-toggle="tab">User Analytics</a></li>
                        <li><a href="#vulns" data-toggle="tab">Vulnerabilities</a></li>
...
<!-- dashboard/############################################################################################################################ -->
                    <div id="dashboard" class="tab-pane active">
                        <div class="box-header">
                            ...
                            <!-- Security News -->
                            <div class="col-lg-3 col-md-3" style="text-align:center;padding:0;">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
