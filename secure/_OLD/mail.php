...
<!-- ############################################################################################################################ -->
    <div class="tab-content">
        ...
        <div class="col-md-3">
          <a href="mail_compose.php" class="btn btn-primary btn-block margin-bottom"><i class="fa fa-edit"></i> Compose </a>
...
if ($mail_code=="r") {
echo '<tr><td class="mailbox-name" width="30%"><i class="fa fa-envelope-open-o"></i> <a href="mail_read.php?id='.$mail_id.'" class="mail-read">' .  substr(($from),0,40) . '</a><br><span class="mail-read">'. $mail_time .'</span><br>';
?>
                <div class="btn-group">
                      
                  <button onclick="window.location.href='mail_delete.php?id=<?php echo ($mail_id);?>'" type="button" class="btn btn-default btn-sm"><i class="fa fa-trash-o" data-toggle="tooltip" title="Delete"></i></button>
                  ...
                  <button onclick="window.location.href='mail_forward.php?id=<?php echo ($mail_id);?>'" type="button" class="btn btn-default btn-sm"><i class="fa fa-share" data-toggle="tooltip" title="Forward"></i></button>
                    <button onclick="window.location.href='mail_print.php?id=<?php echo ($mail_id);?>'" type="button" class="btn btn-default btn-sm" data-toggle="tooltip" title="Print"><i class="fa fa-print"></i></button>
              </div>

                      
<?php
echo '  <td class="mailbox-subject" width="70%"><a href="mail_read.php?id='.$mail_id.'" class="mail-read"><u>' . substr(($subject),0,50).'</u><br>'; 
    echo htmlspecialchars_decode(substr(($message),0,100)) . '...</a></td>';
echo '  </td>';
...
if ($mail_code=="u") {
echo '<tr><td class="mailbox-name" width="30%"><i class="fa fa-envelope"></i> <a href="mail_read.php?id='.$mail_id.'" class="mail-unread">' .  substr(($from),0,40) . '</a><br><span class="mail-unread">'. $mail_time .'</span><br>';
?>
                <div class="btn-group">
