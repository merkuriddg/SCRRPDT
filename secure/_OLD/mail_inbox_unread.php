    ...
    <div class="row">
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-envelope"></i> Unread</h3>
...
if ($mail_code=="u") {
echo '  <tr>
        <td class="mailbox-name" width="30%"><i class="fa fa-envelope"></i> <a href="mail_read.php?id='.$mail_id.'" class="mail-unread">' .  substr(($from),0,40) . '</a><br><span class="mail-unread">'. $mail_time .'</span><br>';
?>
                <div class="btn-group">
