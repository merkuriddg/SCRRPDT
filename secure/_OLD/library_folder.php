    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        ...
        <ul class="nav navbar-nav">
            ...
            <?php include('nots_menu.php'); ?>

            <!-- Tasks: style can be found in dropdown.less -->
            <?php include('tasks_menu.php'); ?>

            <!-- Clocks: style can be found in dropdown.less -->
            <?php include('clocks_menu.php'); ?>            
            
            <!-- User AcCcount: style can be found in dropdown.less -->
            <?php include('useracct_menu.php'); ?>            
                  ...
                  <div class="main">
                    <div class="left">
                        ...
                        <div class="top-droppable folder tooltiper tooltiper-up" data-tooltip="0 file" id="folder1">
                            <p><img src="../dist/img/folder.png" width="100px">
                            Administrative</p>
                        </div>
                        </a>
                        <a href="folder2.php">
