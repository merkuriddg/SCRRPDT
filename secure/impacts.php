            ...
            <div class="box-header">
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-lg-12">
                                <span><i class="fa fa-user-injured"></i> <b><?php echo $companyname; ?>'s Impacts -</b> <em>This is What Might Happen If We Don't Meet our Targets</em></span>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    foreach ($Functions as $rowValue1) {
                                        ...
                                        foreach ($Range as $rowValue2) {
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                if ($rowValue2 == "Low") {echo "<td class='nist-left' style='background-color:lightgray' width='40%' valign='top'><b>" . $rowValue2. " Impact:</b><br>".$ImpactStmt . '</td>'. PHP_EOL;}
                                                if ($rowValue2 == "Med") {echo "<td class='nist-left' style='background-color:darkgray' width='40%' valign='top'><b>" . $rowValue2. " Impact:</b><br>".$ImpactStmt . '</td>'. PHP_EOL;}
                                                if ($rowValue2 == "High") {echo "<td class='nist-left' style='background-color:dimgray' width='40%' valign='top'><b>" . $rowValue2. " Impact:</b><br>".$ImpactStmt . '</td>'. PHP_EOL;}

                                                echo '<td class="text-center"><a href="editImpact.php?id='.$id.'" class="nist-link"><i class="fa fa-check-square"></i></a></td>'. PHP_EOL;
                                                echo '                                    </tr>'. PHP_EOL;
